...
using RayOutEngine.Classes;

namespace RayOutEngine
{
    public partial class MainForm : Form
    {
        ...
        public MainForm()
        {
            ...
            m_Background = Image.FromFile("..\\..\\Resources\\Images\\monika-wroblewska-difuse-snake.jpg");
        }
        ...
        private void MainForm_Paint(object sender, PaintEventArgs e)
        {
            ...
            */
            e.Graphics.DrawImage(m_Background, 0, 0, ClientRectangle.Width, ClientRectangle.Height);
